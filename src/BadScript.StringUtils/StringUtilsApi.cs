...
namespace BadScript.StringUtils
{
    ...
    public static class StringUtilsApi
    {
        #region Public

        public static void AddApi()
        {
            BSTable apiRoot = new BSTable();
            ...
            apiRoot.Lock();
            BSEngine.AddStatic( "string", apiRoot );
        }
        ...
        private static void InsertElement( this ABSTable t, string name, ABSObject o )
        {
