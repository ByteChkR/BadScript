...
namespace BadScript.Utils.Reflection
{
    ...
    public class BSReflectedObject : ABSObject, IBSWrappedObject
    {
        ...
        public BSReflectedObject(Dictionary<string, ABSReference>members, object instance ) : base( SourcePosition.Unknown )
        {
            m_Members = members;
            m_Instance = instance;
        }
        ...
        private bool IsNumericType() => IsNumericType( m_Instance );
